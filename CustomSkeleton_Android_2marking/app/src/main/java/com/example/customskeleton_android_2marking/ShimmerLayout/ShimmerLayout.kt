package com.example.customskeleton_android_2marking.ShimmerLayout
...
class ShimmerLayout @JvmOverloads constructor(
    ...
    private fun createShimmerPaint() {
        ...
        val yPosition:Float = if (0 <= shimmerAngle) height.toFloat() else 0.toFloat()
    ...
    init {
        ...
        try {
            ...
            shimmerColor =
                a.getColor(
                    R.styleable.ShimmerLayout_shimmer_color, getColor(
